    ...
    pDpN: function(e, t) {
      ...
      const E = 'undefined' != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope,
        ...
        P = function(e) {
          ...
          if (S && n === y && 'error' === e.type) {
            const t = e;
            !0 === (r = o && o.call(this, t.message, t.filename, t.lineno, t.colno, t.error)) &&
              e.preventDefault();
        ...
        u || (u = O[l] = _('ON_PROPERTY' + l)),
          ...
          (s.get = function() {
            ...
            if (a) {
              let e = a && a.call(this);
              if (e)
                return s.set.call(this, e), 'function' == typeof n[b] && n.removeAttribute(t), e;
            }
            return null;
          }),
          o(e, t, s),
      ...
      function W(e, t, n) {
        ...
        function v(t, n) {
          ...
          const C = a
              ? function(e) {
                  if (!E.isExisting)
                    return j(e), S.call(E.target, E.eventName, E.capture ? b : k, E.options);
                }
              : function(e) {
      ...
      function re(e, t, n) {
        return (
          ...
          n.configurable ||
            (e[te] || Object.isFrozen(e) || K(e, te, { writable: !0, value: {} }),
            e[te] && (e[te][t] = !0)),
          n
        );
      }
