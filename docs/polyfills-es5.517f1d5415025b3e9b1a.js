  ...
  [3],
  {
        ...
        { target: 'Array', proto: !0, forced: !f('slice') },
        {
          slice: function(t, e) {
            ...
            if (
              ...
              return p.call(v, g, y);
            for (r = new (void 0 === n ? Array : n)(h(y - g, 0)), f = 0; g < y; g++, f++)
              g in v && s(r, f, v[g]);
            return (r.length = f), r;
          },
        },
    ...
    '5s+n': function(t, e, n) {
      ...
      var r,
        ...
        J = function(t, e) {
          _.call(s, function() {
            ...
            if (
              $(e) &&
              ((n = I(function() {
                B ? Z.emit('unhandledRejection', r, t) : Q('unhandledrejection', t, r);
              })),
              (e.rejection = B || $(e) ? 2 : 1),
              n.error)
            )
        ...
        tt = function(t, e) {
          _.call(s, function() {
            B ? Z.emit('rejectionHandled', t) : Q('rejectionhandled', t, e.value);
          });
        },
        et = function(t, e, n, r) {
          return function(o) {
      ...
      V &&
        ((L = function(t) {
          b(this, L, 'Promise'), y(t), r.call(this);
          var e = R(this);
          try {
        ...
        u ||
          ...
          'function' == typeof C &&
            c(
              ...
              {
                fetch: function(t) {
                  return S(L, C.apply(s, arguments));
                },
              },
            ))),
        c({ global: !0, wrap: !0, forced: V }, { Promise: L }),
        v(L, 'Promise', !1, !0),
        d('Promise'),
        (i = f.Promise),
        c(
            ...
            [
              ...
              function(t, o) {
                ...
                for (var m = 0, k = 0, x = []; k < p.length; ) {
                  ...
                  var w,
                    _ = f(y, d ? p : p.slice(k));
                  if (null === _ || (w = v(s(y.lastIndex + (d ? 0 : k)), p.length)) === m)
                    k = u(p, k, g);
                  else {
    ...
    ImZN: function(t, e, n) {
      ...
      (t.exports = function(t, e, n, f, l) {
        ...
        for (; !(y = p.next()).done; ) if ((g = u(p, b, y.value, f)) && g instanceof s) return g;
        return new s(!1);
      }).stop = function(t) {
        return new s(!0, t);
      };
      ...
      !(function() {
        ...
        function t(t, e) {
          ...
          for (b = 0; b < s.length; b++)
            for (var x = h[b], w = (o[x] = {}), _ = 0; _ < r.length; _++) {
              var E;
        ...
        return [
          ...
          function(t, i) {
            ...
            for (var k, x = '', w = 0, _ = 0; _ < b.length; _++) {
              m = b[_];
              for (
                var E = String(m[0]), S = l(p(c(m.index), v.length), 0), T = [], O = 1;
                O < m.length;
                O++
              )
    ...
    bWFh: function(t, e, n) {
      ...
      t.exports = function(t, e, n, d, g) {
        ...
        return (
          (x[t] = m), r({ global: !0, forced: m != y }, x), h(m, t), g || n.setStrong(m, t, d), m
        );
      };
    },
    brp2: function(t, e, n) {
    ...
    fHMY: function(t, e, n) {
      ...
      (t.exports =
        ...
        function(t, e) {
          ...
          return (
            null !== t
              ? ((f.prototype = r(t)), (n = new f()), (f.prototype = null), (n[s] = t))
              : (n = l()),
            void 0 === e ? n : o(n, e)
          );
        }),
        ...
        { target: 'Array', proto: !0, forced: !f('splice') },
        {
          splice: function(t, e) {
            ...
            if (((f.length = r), n < r)) {
              ...
              for (h = y - r; h > b; h--)
                (d = h + n - 1), (v = h + r - 1) in g ? (g[d] = g[v]) : delete g[d];
    ...
    pDpN: function(t, e) {
      !(function(t) {
        ...
        var i = (function() {
          ...
          return (
            ...
            (i.scheduleMicroTask = function(t, e, n, r) {
              return this.scheduleTask(new s(E, t, e, n, r, void 0));
            }),
            (i.scheduleMacroTask = function(t, e, n, r, o) {
              return this.scheduleTask(new s(S, t, e, n, r, o));
            }),
            (i.scheduleEventTask = function(t, e, n, r, o) {
              return this.scheduleTask(new s(T, t, e, n, r, o));
            }),
            (i.cancelTask = function(t) {
              if (t.zone != this)
                throw new Error(
            ...
            (i._updateTaskCount = function(t, e) {
        ...
        var a,
          ...
          u = (function() {
            ...
            return (
              ...
              (e._updateTaskCount = function(t, e) {
          ...
          s = (function() {
            ...
            var n = e.prototype;
            return (
              (n.cancelScheduleRequest = function() {
                this._transitionTo(b, m);
              }),
              (n._transitionTo = function(t, e, n) {
        ...
        Zone.__load_patch('ZoneAwarePromise', function(t, e, n) {
            ...
            if (t[d] === x) {
              ...
              if (
                ...
                if (
                  ...
                  r === _ && i instanceof Error)
                ) {
                  var p = e.currentTask && e.currentTask.data && e.currentTask.data[s];
                  p && o(i, I, { configurable: !0, enumerable: !1, writable: !0, value: p });
                }
            ...
            (t.toString = function() {
              ...
              (t.race = function(t) {
                ...
                for (a = c ? a : a[Symbol.iterator](); ; ) {
                  ...
                  var f = s;
                  p(f) || (f = this.resolve(f)), f.then(o, i);
                }
                return r;
              }),
              (t.all = function(t) {
                var e,
                  ...
                  u = function() {
                    if (f) {
                      if (l >= s.length) return 'break';
                      h = s[l++];
                    } else {
                      if ((l = s.next()).done) return 'break';
                      h = l.value;
                    }
                    var t = h;
                    p(t) || (t = r.resolve(t));
          ...
          (L && !L.configurable) ||
            ...
            (L.set = function(e) {
              e === R ? (t[A] = e) : ((t[c] = e), e.prototype[u] || Z(e), n.setNativePromise(e));
            }),
            o(t, 'Promise', L)),
            (t.Promise = R);
          var F,
            ...
            f || (f = I[s] = g('ON_PROPERTY' + s)),
              ...
              (i.get = function() {
                ...
                if (c) {
                  ...
                  if (o)
                    return (
                      i.set.call(this, o), 'function' == typeof n[k] && n.removeAttribute(e), o
                    );
                }
                return null;
              }),
      ...
      function X(t, e, n) {
            ...
            if ((e = e || t.event)) {
              ...
              if (r)
                if (1 === r.length) b(r[0], n, e);
                  ...
                  for (var o = r.slice(), i = 0; i < o.length && (!e || !0 !== e[V]); i++)
                    b(o[i], n, e);
            }
          },
          k = function(e) {
        ...
        function x(e, n) {
          ...
          var P = c
              ? function(t) {
                  if (!T.isExisting)
                    return j(t), O.call(T.target, T.eventName, T.capture ? k : m, T.options);
                }
              : function(t) {
            ...
            R = c
              ? function(t) {
                  ...
                  if (t.allRemoved)
                    return I.call(t.target, t.eventName, t.capture ? k : m, t.options);
                }
              : function(t) {
                  ...
                  if (!u || u(e, v, s, arguments)) {
                    ...
                    if (A)
                      for (var y = 0; y < A.length; y++)
                        if (f === A[y]) return e.apply(this, arguments);
                    var m,
                      k = !1;
                    void 0 === g
                      ? (m = !1)
                    ...
                    if (_) x = _[m ? l : p];
                      ...
                      var O = (E ? E(f) : f) + p,
                        ...
                        M = h + O,
                        D = h + I;
                      (H[f] = {}), (H[f][p] = M), (H[f][l] = D), (x = m ? D : M);
                    }
                    var j,
                      P = s[x],
                      R = !1;
                    if (P) {
                      if (((R = !0), b)) for (var L = 0; L < P.length; L++) if (N(P[L], v)) return;
                    } else P = s[x] = [];
                    ...
                    var Z = c ? G : void 0;
                    Z && (Z.taskData = T);
                    var C = w.scheduleEventTask(j, v, Z, r, o);
                    return (
                      (T.target = null),
                      Z && (Z.taskData = null),
                      k && (g.once = !0),
                      (W || 'boolean' != typeof C.options) && (C.options = g),
                      (C.target = s),
                      (C.capture = m),
                      (C.eventName = f),
                      d && (C.originalDelegate = v),
                      a ? P.unshift(C) : P.push(C),
                      i ? s : void 0
                    );
                  }
                }
          ...
          return (
            ...
            (w[a] = function() {
              for (
                var e = this || t, n = arguments[0], r = [], o = Y(e, E ? E(n) : n), i = 0;
                i < o.length;
                i++
              ) {
                var a = o[i];
      ...
      function it(t, e, n) {
        return (
          ...
          n.configurable ||
            (t[nt] || Object.isFrozen(t) || $(t, nt, { writable: !0, value: {} }),
            t[nt] && (t[nt][e] = !0)),
          n
        );
      }
      ...
      function mt(t, e) {
        if ((!S || O) && !Zone[t.symbol('patchEvents')]) {
          ...
          s && bt(s.prototype, pt, r);
          var f = e.XMLHttpRequestEventTarget;
          f && bt(f && f.prototype, pt, r),
            'undefined' != typeof IDBIndex &&
              (bt(IDBIndex.prototype, ht, r),
              bt(IDBRequest.prototype, ht, r),
              bt(IDBOpenDBRequest.prototype, ht, r),
              bt(IDBDatabase.prototype, ht, r),
              bt(IDBTransaction.prototype, ht, r),
              bt(IDBCursor.prototype, ht, r)),
            n && bt(WebSocket.prototype, vt, r);
        }
      }
      Zone.__load_patch('util', function(t, e, o) {
        (o.patchOnProperties = j),
          (o.patchMethod = A),
          (o.bindArguments = w),
          (o.patchMacroTask = L);
        ...
        Zone.__load_patch('XHR', function(t, e) {
          !(function(u) {
            ...
            function T(t) {
              ...
              return h.call(r, m, u), r[n] || (r[n] = t), E.apply(r, e.args), (r[i] = !0), t;
            }
            function O() {}
            function I(t) {
              var e = t.data;
    ...
    pNMO: function(t, e, n) {
      ...
      var r = n('I+eb'),
        ...
        rt = function(t, e) {
          ...
          return Z(n, { type: 'Symbol', tag: t, description: e }), a || (n.description = e), n;
        },
        ot =
          ...
          return function(h, v, d, g) {
            for (
              var y,
                ...
                _ = 0,
                E = g || c,
                S = e ? E(h, w) : n ? E(h, 0) : void 0;
              w > _;
              _++
            )
              if ((p || _ in k) && ((b = x((y = k[_]), _, m)), t))
                if (e) S[_] = b;
                else if (b)
                  switch (t) {
                    case 3:
