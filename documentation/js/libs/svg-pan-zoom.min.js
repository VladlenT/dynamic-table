        ...
        (s.prototype.init = function(t, e) {
          ...
          (s.prototype.processCTM = function() {
            ...
            if (this.options.center) {
              var o = 0.5 * (this.options.width - (this.viewBox.width + 2 * this.viewBox.x) * t.a),
                n = 0.5 * (this.options.height - (this.viewBox.height + 2 * this.viewBox.y) * t.a);
              (t.e = o), (t.f = n);
            }
            return (
            ...
            if (e || o) {
              if (
                ...
                var n = this.options.beforePan(this.getPan(), { x: t.e, y: t.f }),
                  ...
                  r = !1;
                n === !1
                  ? ((t.e = this.getPan().x), (t.f = this.getPan().y), (s = r = !0))
                  : i.isObject(n) &&
                    (n.x === !1
        ...
        (l.prototype.init = function(t, e) {
          ...
          (l.prototype.enableMouseWheelZoom = function() {
            if (!this.options.mouseWheelZoomEnabled) {
              ...
              n.on(this.options.eventsListenerElement || this.svg, this.wheelListener, e),
          ...
          (l.prototype.handleMouseWheel = function(t) {
            if (this.options.zoomEnabled && 'none' === this.state) {
              ...
              (this.lastMouseWheelEventTime = Date.now()),
                ...
                (e = -0.3 < e && e < 0.3 ? e : ((e > 0 ? 1 : -1) * Math.log(Math.abs(e) + 10)) / n);
              ...
              this.publicInstance ||
                (this.publicInstance = this.pi = {
                  ...
                  setBeforePan: function(e) {
                    return (
                      (t.options.beforePan = null === e ? null : s.proxy(e, t.publicInstance)), t.pi
                    );
                  },
                  setOnPan: function(e) {
                    return (
                      (t.options.onPan = null === e ? null : s.proxy(e, t.publicInstance)), t.pi
                    );
                  },
                  enableZoom: function() {
                  ...
                  setBeforeZoom: function(e) {
                    return (
                      (t.options.beforeZoom = null === e ? null : s.proxy(e, t.publicInstance)),
                      t.pi
                    );
                  },
                  setOnZoom: function(e) {
                    return (
                      (t.options.onZoom = null === e ? null : s.proxy(e, t.publicInstance)), t.pi
                    );
                  },
                  zoom: function(e) {
                  ...
                  setOnUpdatedCTM: function(e) {
                    return (
                      (t.options.onUpdatedCTM = null === e ? null : s.proxy(e, t.publicInstance)),
                      t.pi
                    );
                  },
                  resetZoom: function() {
            ...
            getOrCreateViewport: function(t, e) {
              ...
              return (
                ...
                ~l.indexOf('svg-pan-zoom_viewport') ||
                  (l.push('svg-pan-zoom_viewport'), o.setAttribute('class', l.join(' '))),
                o
              );
            },
            ...
            setCTM: function(t, e, o) {
              ...
              t.setAttributeNS(null, 'transform', s),
                'transform' in t.style
                  ...
                  : '-webkit-transform' in t.style && (t.style['-webkit-transform'] = s),
                'ie' === i &&
                  o &&
          ...
          throttle: function(t, e, o) {
            ...
            return function() {
              ...
              return (
                ...
                (i = arguments),
                c <= 0 || c > e
                  ? (clearTimeout(a), (a = null), (l = h), (s = t.apply(n, i)), a || (n = i = null))
