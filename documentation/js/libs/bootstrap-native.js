...
!(function(t, e) {
  ...
  for (
    var t = function(t, e) {
        t.classList ? t.classList.add(e) : ((t.className += ' ' + e), t.offsetWidth);
      },
      e = function(t, e) {
        t.classList
      ...
      o =
        null != new RegExp('MSIE ([0-9]{1,}[.0-9]{0,})').exec(navigator.userAgent) &&
        parseFloat(RegExp.$1),
      n = function(t, e) {
      ...
      i =
        ...
        function(i, a) {
          (a = a || {}),
            ...
            (this.duration = 300),
            (this.options = {}),
            (this.options.duration = o && o < 10 ? 0 : a.duration || this.duration);
          var r = this,
            s = function(t) {
              var e = t && (t.currentStyle || window.getComputedStyle(t)),
                o = /px/.test(e.borderTopWidth)
                  ...
                  : 0,
                n = /px/.test(e.marginTop) ? Math.round(e.marginTop.replace('px', '')) : 0,
                i = /px/.test(e.marginBottom) ? Math.round(e.marginBottom.replace('px', '')) : 0,
                a = /em/.test(e.marginTop)
                  ? Math.round(e.marginTop.replace('em', '') * parseInt(e.fontSize))
                  : 0,
                r = /em/.test(e.marginBottom)
                  ? Math.round(e.marginBottom.replace('em', '') * parseInt(e.fontSize))
                  : 0;
              return (
                t.clientHeight + parseInt(o) + parseInt(n) + parseInt(i) + parseInt(a) + parseInt(r)
              );
            };
          (this.toggle = function(t) {
            t.preventDefault(), /\bin/.test(r.collapse.className) ? r.close() : r.open();
          }),
            (this.close = function() {
            ...
            (this._open = function(o) {
              this.removeEvent(),
                ...
                t(o, 'collapsing'),
                setTimeout(function() {
                  (o.style.height = r.getMaxHeight(o) + 'px'), (o.style.overflowY = 'hidden');
                }, 0),
                setTimeout(function() {
                  (o.style.height = ''), (o.style.overflowY = ''), e(o, 'collapsing'), r.addEvent();
            ...
            (this._close = function(o) {
              this.removeEvent(),
                ...
                setTimeout(function() {
                  (o.style.height = '0px'), (o.style.overflowY = 'hidden'), t(o, 'collapsing');
                }, 0),
                setTimeout(function() {
                  e(o, 'collapsing'),
                    e(o, 'in'),
            ...
            (this.getMaxHeight = function(t) {
              for (var e = 0, o = 0, n = t.children.length; o < n; o++) e += s(t.children[o]);
              return e;
            }),
            ...
            (this.getTarget = function() {
              var t = this.btn,
                ...
                o = t.getAttribute('data-target') && t.getAttribute('data-target'),
                n = e || (o && /#/.test(o) && o.replace('#', '')),
                i = o && '.' === o.charAt(0) && o;
              return (n && document.getElementById(n)) || (i && document.querySelector(i));
            }),
            this.addEvent(),
  ...
  for (
    var c = function(n, i) {
        (i = i || {}),
          ...
          /\bdropdown-menu/.test(this.tabs.className) &&
            ((this.dropdown = this.tabs.parentNode), (this.tabs = this.tabs.parentNode.parentNode)),
          (this.options = i),
          (this.duration = 150),
          (this.options.duration = o && o < 10 ? 0 : i.duration || this.duration);
        var a = this;
        (this.handle = function(o) {
          (o = o || window.e).preventDefault();
          var n = o.target,
            i = document.getElementById('c-' + n.getAttribute('href').replace('#', '')),
            r = a.getActiveTab(),
          ...
          /\bactive/.test(n.parentNode.className) ||
            ...
            a.dropdown &&
              (/\bdropdown-menu/.test(a.tab.parentNode.parentNode.className)
                ? /\bactive/.test(a.dropdown.className) || t(a.dropdown, 'active')
                : /\bactive/.test(a.dropdown.className) && e(a.dropdown, 'active')),
            e(s, 'in'),
            setTimeout(function() {
      ...
      d = document.querySelectorAll("[data-toggle='tab'], [data-toggle='pill']"),
      u = 0,
      h = d.length;
    u < h;
    u++
    ...
    var p = d[u],
      g = {};
    (g.duration = (p.getAttribute('data-duration') && p.getAttribute('data-duration')) || !1),
      new c(p, g);
  }
